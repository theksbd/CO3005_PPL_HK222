...
#         self.assertTrue(TestLexer.test("Wri_teLn", "Wri_teLn,<EOF>", 102))
#     def test_identifier3(self):
#         self.assertTrue(TestLexer.test("1Wri_teLn", "Error Token 1", 103))
#     def test_identifier4(self):
#         self.assertTrue(TestLexer.test("_1 Write", "Error Token W", 104))
#     def test_identifier5(self):
#         self.assertTrue(TestLexer.test("abc", "abc,<EOF>", 105))
import unittest
from TestUtils import TestLexer
